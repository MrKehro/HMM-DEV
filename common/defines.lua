...
NCountry = {
	...
	DISINHERIT_PRESTIGE_THRESHOLD = -25,
...
NEconomy = {
	...
	EDICTS_DURATION_MONTHS = 1,				-- months lastin at least.
...
NMilitary = {
	...
	ASSAULT_ATTACKER_LOSS = 1, 					-- MDEF_ASSAULT_ATTACKER_LOSS = 10,
